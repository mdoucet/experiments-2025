...
def create_fit_experiment(q, dq, data, errors):
    ...
    sample['THF'].material.rho.range(1, 2)
...
ar_dir = '/Users/jenni/OneDrive/Desktop/GitHub_2/experiments-2025/jen-apr2025/data/Sample8'

data_file = os.path.join(ar_dir, 'REFL_218420_combined_data_auto.txt')
