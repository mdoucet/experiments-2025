...
def create_sample(sld_h2o=5.5, has_oxide=False):
    ...
    if has_oxide:
        sample = ( air(0, 1) | ionomer(600, 5) | Pt(145.318, 7.4) | PtOx(50, 5) | Ti(26.797,11.4) | SiOx(18.1, 4.6) | Si )
        
    else:
        sample = ( air (0, 1) | ionomer(600, 5) |  Pt(145.318, 7.4) | Ti(26.797,11.4) | Si )
    ...
    sample["ionomer"].thickness.range(100,1500)
...
ar_dir = "/Users/jenni/OneDrive/Desktop/GitHub_2/experiments-2025/jen-mar2026/Sample7/Rawdata"
...
data_files = [
    os.path.join(ar_dir, "REFL_226667_1_226667_partial.txt" ),
    os.path.join(ar_dir, "REFL_226667_2_226668_partial.txt"),
    os.path.join(ar_dir, "REFL_226667_3_226669_partial.txt"),
]
