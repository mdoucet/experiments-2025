...
def create_sample(sld_D2O=6.3, has_oxide=True):
    ...
    if has_oxide:
        sample = (
            D2O(0, 25) | ionomer(500, 20)| SL1(50, 20) | PtOx(50, 5) | Pt(145.318, 7.4) | Ti(26.797,11.4) | Si
        )
    else:
        sample = D2O(0, 25) | ionomer(500, 20) | SL1(50, 20) | Pt(145.318, 7.4) | Ti(26.797,11.4) | SiOx(18.1, 4.6) | Si
