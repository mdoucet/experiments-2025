...
data_files = [
    os.path.join(ar_dir, "REFL_226661_1_226661_partial.txt" ),
    os.path.join(ar_dir, "REFL_226661_2_226662_partial.txt"),
    os.path.join(ar_dir, "REFL_226661_3_226663_partial.txt"),
]
