...
def create_sample(sld_h2o=5.5, has_oxide=True):
    ...
    if has_oxide:
        sample = H2O(0, 25) | SL2(20,3) | ionomer(950, 20) | CuOx(50, 5) | Cu(151.9, 12) | Ti(26.7, 4.38) | SiOx(20.151, 1) | Si
    else:
        sample = H2O(0, 25) | SL2(157,49) | ionomer(950, 20) | Cu(151.9, 12) | Ti(26.7, 4.38) | SiOx(20.151, 1) | Si
