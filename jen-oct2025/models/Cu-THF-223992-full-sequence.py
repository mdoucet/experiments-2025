...
exp_list_ocv1[0].probe.intensity = Parameter(value=1, name="Intensity_992_1")
exp_list_ocv1[0].probe.intensity.pm(0.1)
#exp_list_ocv1[0].probe.background = Parameter(value=0, name="Background_992_1")
...
exp_list_ocv2[0].probe.intensity = Parameter(value=1, name="Intensity_996_1")
exp_list_ocv2[0].probe.intensity.range(0.5, 1.2)
#exp_list_ocv2[0].probe.background = Parameter(value=0, name="Background_996_1")
...
if INCLUDE_TNR:
    ...
    data_files = [
        [os.path.join(tNR_dir, f"r{run}_hold_step1_0.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_hold_step8_5.txt"), 1.2],
    ]

    # tNR during EIS
    data_files = [
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step0_p0p00V_Eoc.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step1_m0p10V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step2_m0p10V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step3_m0p20V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step4_m0p20V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step5_m0p30V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step6_m0p30V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step7_m0p40V_Ref.txt"), 1.2],
        [os.path.join(tNR_dir, f"r{run}_Sample9_CuOx_D2O_NaHCO3_02_PEIS_C01_step8_m0p40V_Ref.txt"), 1.2],
    ]
    for i in range(len(data_files)):
        probe = create_probe(data_files[i][0], data_files[i][1])
        sample = create_sample(sld_thf=sld_thf)
