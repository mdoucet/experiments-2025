...
def create_sample(sld_h2o=5.5, has_oxide=False):
    ...
    if has_oxide:
        ...
        sample = H2O(0, 25) | SL2(20,3) | ionomer(950, 20) | SL1(30,3) | Pt(151.9, 12) | Ti(26.7, 4.38) | SiOx(20.151, 1) | Si
...
data_files = [
    os.path.join(ar_dir, "REFL_223960_1_223960_partial.txt" ),
    os.path.join(ar_dir, "REFL_223960_2_223961_partial.txt"),
    os.path.join(ar_dir, "REFL_223960_3_223962_partial.txt"),
]
